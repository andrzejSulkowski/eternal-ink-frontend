...
function LoadingFileBanner({ src, name, size, onRemove }: Props) {
  return (
    <div className="bg-[#09090A] border border-solid border-[#242438] flex justify-between w-full px-6 py-4 text-sm rounded-2xl">
      ...
      <button onClick={onRemove} className="text-ei-danger font-normal">Remove</button>
    </div>
  );
}
